...
in this solution, we start at a reject state; and no matter the input,
the machine will always end in a reject state.

![graphs/01_design_ex1.2.gv](./static/01_design_ex1.2.svg)

this looks like a more complicated example; however, since it have no
